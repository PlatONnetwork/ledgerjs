...
var remapTransactionRelatedErrors = function (e) {
    if (e && e.statusCode === 0x6a80) {
        return new LatAppPleaseEnableContractData("Please enable Contract data on the Lat app Settings");
    }
    return e;
};
/**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        toSend = [];
                        rlpTx = ethers.utils.RLP.decode("0x" + rawTxHex).map(function (hex) {
                        ...
                        provideForContract = function (address) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        prc20Info = byContractAddress(address);
                                        if (!prc20Info) return [3 /*break*/, 2];
                                        log("Lat", "loading prc20token info for " +
                        ...
                        infos = getInfosForContractMethod(decodedTx.to, selector);
                    ...
                    case 13:
                        _b.sent();
                        _b.label = 14;
                    case 14: return [2 /*return*/, foreach(toSend, function (data, i) {
